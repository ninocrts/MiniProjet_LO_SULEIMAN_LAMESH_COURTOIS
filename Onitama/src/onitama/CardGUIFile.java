...
public class CardGUIFile extends JPanel {
	...
	public CardGUIFile(CardGUIFile cg) {
		this(cg, cg.getColor());
	}

	public CardGUIFile(CardGUIFile cg, int color) {
		init();
		this.color = color;
		set(cg);
	}

	public CardGUIFile(CardFIle c, int color) {
		init();
	...
	public void set(CardGUIFile cg, int color) {
		set(cg);
		this.color = color;
	}

	public void set(CardGUIFile cg) {
		setText(cg.getText());
